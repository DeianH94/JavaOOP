package DefiningClasses.Pr10FamilyTree;
    ...
    public static void main(String[] args) throws IOException {
        ...
        halfDataPeople.stream().forEach(partialPerson -> {
            fullDataPeople.stream().filter(fullPerson -> fullPerson.getBirthday().equals(partialPerson.getBirthday()) ||
                ...
                partialPerson.getParents().stream().forEach(fullPerson::addParent);
                partialPerson.getChildren().stream().forEach(fullPerson::addChild);
